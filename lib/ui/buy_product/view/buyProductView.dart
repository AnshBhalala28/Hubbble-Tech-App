...
import 'package:wavee/ui/community_screen/provider/communityProvider.dart';
...
import '../../cart_screen/model/cartDetailsModal.dart';
import '../../cart_screen/provider/addToCartProvider.dart';
import '../../thank_you_page/view/thankYouPage.dart';
      ...
      child: Column(
        ...
        children: [
          Container(
            padding: EdgeInsets.all(3.w),
            decoration: BoxDecoration(
              color: isDark ? const Color(0xff2B2B2B) : Colors.grey[50],
              // border: Border.all(color: isDark?Color(0xff383838):Colors.grey),
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: isDark ? const Color(0xff383838) : Colors.grey,
                    ),
  ...
  Widget _buildHoursRow(String day, dynamic dayHours) {
    ...
    return Container(
      ...
      decoration:
          isToday
              ? BoxDecoration(
                color: isDark ? const Color(0xff373737) : AppColors.maincolor,
