...
import 'package:wavee/ui/order_screen/view/orderDetailsScreen.dart';
...
import '../../buy_product/view/buyProductView.dart';
...
import '../../order_screen/provider/orderProvider.dart';
import '../../order_screen/view/orderScreenView.dart';
...
class _AddToCartViewState extends State<AddToCartView> {
          ...
          children: [
            ...
            Row(
              children: [
                ...
                const Spacer(),
                const ThemeToggleButton().paddingOnly(bottom: 2.5.h),
              ],
            ),
            SizedBox(height: 5.h),
            ...
            Expanded(
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: isDark ? const Color(0xff242424) : AppColors.white,
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color:
                                isDark
                                    ? const Color(0xf0313131)
                                    : const Color(0xf0E9EBF1),
                          ),
                        ).paddingOnly(top: 1.h),
                      ],
                    ),
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: isDark ? const Color(0xffbdab82) : Colors.white,
  ...
  Widget _buildOrderCard(Data3 order) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(25),
        border: Border.all(
          color: isDark ? const Color(0xff373737) : Colors.grey.shade200,
          width: 1,
        ),
      ),
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color:
                    isDark ? const Color(0xf0313131) : const Color(0xf0E9EBF1),
              ),
              ...
              children: [
                Text(
                  ...
                  style: TextStyle(
                    ...
                    fontWeight: FontWeight.w700,
                    color:
                        isDark ? const Color(0xffbdab82) : AppColors.maincolor,
                    fontFamily: AppConstants.manropeBold,
                  ),
                ...
                batan(
                  ...
                  color:
                      isDark
                          ? const Color(0xff3C3A35)
                          : const Color(0xf0ECEDF1),
                  fontcolor:
                      isDark ? const Color(0xffbdab82) : AppColors.maincolor,
                  height: 5.h,
                  width: 40.w,
        ...
        child: Column(
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                color:
                    isDark ? const Color(0xf035332E) : const Color(0xFFF1F2F6),
                shape: BoxShape.circle,
              ),
              child: Icon(
                Icons.receipt_long,
                size: 15.w,
                color: isDark ? const Color(0xf0CBB88C) : AppColors.lightText,
              ),
            ),
            SizedBox(height: 3.h),
            Text(
              ...
              style: TextStyle(
                ...
                fontSize: 20.sp,
                fontWeight: FontWeight.w600,
                color: isDark ? Colors.white : const Color(0xFF2E3333),
              ),
            ),
            SizedBox(height: 1.h),
            Text(
            ...
            batan(
              ...
              color: isDark ? const Color(0xffbdab82) : AppColors.lightText,
            ...
            Row(
              ...
              children: [
                ...
                batan(
                  ...
                  color:
                      isDark
                          ? const Color(0xFFCDBA81).withOpacity(0.2)
                          : const Color(0xf0F1F2F6),
                  fontcolor:
                      isDark
        ...
        itemBuilder: (context, index) {
          ...
          return Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color:
                    isDark ? const Color(0xff383838) : const Color(0xffE6E7ED),
              ),
            ),
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    color: isDark ? const Color(0xffbdab82) : Colors.grey,
                    fontSize: 14,
                    fontWeight: FontWeight.bold,
                  ),
                ),
  ...
  Widget _buildCartItem(dynamic item) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        color: isDark ? const Color(0xff272727) : Colors.white,
        border: Border.all(
          color: isDark ? const Color(0xff373737) : const Color(0xFF969696),
          width: 1,
        ),
      ),
      child: Row(
                    ...
                    Expanded(
                      child: Text(
                        ...
                        style: TextStyle(
                          ...
                          fontFamily: AppConstants.manropeBold,
                          color:
                              isDark ? Colors.white : const Color(0xFF2E3333),
                        ),
                      ),
                    ),
                    GestureDetector(
  ...
  Widget _buildQuantityControl(dynamic item) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: isDark ? const Color(0xff3A3934) : Colors.grey.shade200,
        borderRadius: BorderRadius.circular(20),
      ),
      child: Row(
        mainAxisSize: MainAxisSize.min,
