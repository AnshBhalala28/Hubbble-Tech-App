        ...
        title: Row(
          children: [
            IconButton(
              icon: Icon(
                Icons.arrow_back,
                color: isDark ? const Color(0xffbdab82) : Colors.black,
              ),
              onPressed: () => Get.back(),
            ),
            Expanded(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    prefixIcon: Icon(
                      Icons.search,
                      color:
                          isDark ? const Color(0xffbdab82) : Colors.grey[600],
                      size: 20,
                    ),
                    suffixIcon:
                ...
                child: Column(
                  ...
                  children: [
                    Icon(
                      ...
                      size: 60,
                      color:
                          isDark ? const Color(0xffbdab82) : Colors.grey[300],
                    ),
                    ...
                    Text(
                      ...
                      style: TextStyle(
                        fontSize: 16,
                        color:
                            isDark ? const Color(0xffbdab82) : Colors.grey[500],
