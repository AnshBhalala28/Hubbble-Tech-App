...
class GlobalCountsController extends GetxController {
  ...
  void _startPeriodicTimer() {
    ...
    if (!_isPollingActive) return; // Jo polling bandh thai gayu hoy to chalu na karo
  ...
  void _handleRateLimit() {
    if (_isPausedForRateLimit) return; // Jo pela thi j pause chhe to kai na karo
    ...
    try {
      ...
      if (response.statusCode == 200) {
        visitorShowCountModel =
            VisitorShowCountModel.fromJson(response.data);
