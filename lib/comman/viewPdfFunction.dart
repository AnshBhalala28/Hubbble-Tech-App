        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween, // <-- લેઆઉટ સુધાર્યું
                children: [
                  IconButton(
                    onPressed: () => Get.back(),
                    icon: Icon(
                  ...
                  Expanded(
                    child: Text(
                      ...
                      style: TextStyle(
                        fontSize: 16.sp, // ફોન્ટ સાઈઝ થોડી નાની કરી
                        fontFamily: "task",
                        letterSpacing: 1,
                        color: Colors.white,
        ...
        child: Center(
          child: Image.network(
            ...
            loadingBuilder: (context, child, loadingProgress) {
              ...
              return const Center(
                  child:
                  CircularProgressIndicator(color: Colors.white)); // કલર ઉમેર્યો
            },
