...
class _CommunityScreenState extends State<CommunityScreen>with WidgetsBindingObserver {
  ...
  Future<BitmapDescriptor> _getClusterMarker(
      int count, String profileImageUrl) async {
    const int size = 120;
  ...
  Future<Uint8List> getBytesFromCanvas(
    ...
    try {
      ...
      final Path logoPath = Path()
        ..addOval(Rect.fromCircle(center: logoCenter, radius: logoRadius - 3));
    ...
    if (hasStory && storyPreviewUrl?.isNotEmpty == true) {
      ...
      try {
        ...
        canvas.drawImage(
          storyImage,
          Offset(storyCenter.dx - storyRadius + 5,
        ...
        trianglePath.lineTo(storyCenter.dx - triangleWidth,
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 1.h),
                      if ((busnessviewmodal?.data?.posts ?? []).isNotEmpty ||
                          (busnessviewmodal?.data?.events ?? []).isNotEmpty ||
                          (busnessviewmodal?.data?.offerPromotions ?? [])
                              .isNotEmpty ||
                          (busnessviewmodal?.data?.services ?? []).isNotEmpty ||
                          (busnessviewmodal?.data?.products ?? []).isNotEmpty)
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                      ...
                      Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              InkWell(
                                onTap: () {
                                  final address = busnessviewmodal
                                      ?.data?.business?.user?.address;
                                  if (address != null &&
                              ...
                              InkWell(
                                onTap: () {
                                  final website =
                                      busnessviewmodal?.data?.business?.website;
  ...
  Future<void> BussinessProfile() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        businessprofileModel =
            BusinessProfileModel.fromJson(json.decode(response.body));
  ...
  businesssearchapi() {
    final Map<String, String> data = {
      "business_name": search.text.toString(),
    };
      ...
      if (internet) {
        CommunityProvider()
          ...
          data,
            ...
            .then((response) async {
          busnesssearchModal =
              BusnessSearchModal.fromJson(json.decode(response.body));
          if (response.statusCode == 200) {
            setState(() {
    ...
    checkInternet().then((internet) async {
      if (internet) {
        try {
          ...
          if (response.statusCode == 200) {
            getvisitedModal =
                GetVisitedModal.fromJson(json.decode(response.body));
          }
        ...
        CommunityProvider()
          ...
          if (response.statusCode == 200) {
            ...
            await _showcategoriesdBottomSheet(
                viewcategoriesmodel, categoryName, categoryImage);
          } else if (response.statusCode == 422) {
            setState(() {
              isSending = false;
            });
