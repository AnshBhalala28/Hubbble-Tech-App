...
class CommunityProvider extends ChangeNotifier {
  Future<Response> businessProfileApi(
    ...
    try {
      ...
      print("Business Profile Response avece: ${response.data}");
      return response;
  ...
  Future<Response> businessProfileViewApi(String id, lat, lon) async {
    try {
      ...
      print("Sucess Data ave che k nai ee janavo ${response.data}");
      return response;
    } on DioException catch (e) {
      throw Exception(handleDioError(e));
    }
  ...
  Future<Response> getCategoryApi() async {
    try {
      ...
      print("busienss profile Category${response.data}");
      return response;
    } on DioException catch (e) {
      throw Exception(handleDioError(e));
    }
