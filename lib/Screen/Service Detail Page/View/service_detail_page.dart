                              ...
                              child: SingleChildScrollView(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: (servicedetailsmodel
                                                    ?.data?.galleryImages ==
                                                null ||
                                            servicedetailsmodel!
                                                .data!.galleryImages!.isEmpty)
                                        ? ClipRRect(
                                            borderRadius:
                                                BorderRadius.circular(10),
                                            child: CachedNetworkImage(
                                              imageUrl: servicedetailsmodel
                                                      ?.data?.images ??
                                                  "",
                                              fit: BoxFit.cover,
                                              width: double.infinity,
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          ...
          if (servicedetailsmodel?.data?.features != null) {
            featuresList =
                List<String>.from(servicedetailsmodel!.data!.features!);
          }

          if (servicedetailsmodel?.data?.benefits != null) {
            benefitsList =
                List<String>.from(servicedetailsmodel!.data!.benefits!);
          }
        });
