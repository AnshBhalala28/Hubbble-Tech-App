...
//                                                         calendar1SelectedDate !=
//                                                                 null
//                                                             ? "Operating Hours: ${getOperatingHours(calendar1SelectedDate!, selectedAmenity?.operatingHours)}"
//                                                             : "Select a date",
//                                                         style: TextStyle(
//                                                           letterSpacing: 1,
//                                                           fontSize: 16.sp,
...
//                                 amenitiesModel?.data?.data?[0].availableSlots ??
//                                 0;
//                             if (availableSlots <= 0) {
//                               ScaffoldMessenger.of(context).showSnackBar(
//                                 const SnackBar(
...
//                                   content: Text(
//                                     "Sorry, no slots are available for the selected date.",
//                                   ),
//                                 ),
//                               );
//                               return;
...
//     if (calendar1SelectedDate != null &&
//         calendar1SelectedDate!.month == calendar1FocusedMonth.month &&
//         calendar1SelectedDate!.year == calendar1FocusedMonth.year) {
//       calendar1FocusDay = calendar1SelectedDate!;
//     } else {
//       calendar1FocusDay = calendar1FirstDay;
//     }
//
...
// તમારા પ્રોજેક્ટના સાચા પાથ (paths) અહીં વાપરો
import 'package:wavee/Screen/Booking/View/book_amenities.dart';
import 'package:wavee/Screen/homePage/View/homenewpage.dart';
import 'package:wavee/comman/custom_batan.dart';
import 'package:wavee/comman/loader.dart';
...
// ખાતરી કરો કે આ મોડેલ અપડેટેડ છે (જેમાં ExistingBooking ક્લાસ છે)
import '../Model/booking_model.dart';
import '../Provider/booking_provider.dart';
import 'booking_screen.dart';
