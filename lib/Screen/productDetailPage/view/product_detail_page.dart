...
import 'package:wavee/Screen/productDetailPage/model/product_model.dart';
import 'package:wavee/Screen/productDetailPage/provider/product_provider.dart';
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          (productViewModel?.data?.images == null ||
                            ...
                            items:
                            productViewModel!.data!.images!.map((imageUrl,) {
                              return Builder(
