...
import 'package:wavee/Screen/UpcomingRequest/Model/OnGoing_Freind_Request_Model.dart';
import 'package:wavee/Screen/UpcomingRequest/Model/get_my_new_request.dart';
import 'package:wavee/Screen/UpcomingRequest/Model/my_request_model.dart';
import 'package:wavee/Screen/UpcomingRequest/Provider/upcomeing_request_provider.dart';
...
class _RequestPageState extends State<RequestPage> {
  ...
  GetMyRequest() {
    checkInternet().then((internet) async {
      if (internet) {
        MyRequestProvider()
            .GetMyRequest(loginModel?.data?.user?.id.toString() ?? "")
            .then((response) async {
              myRequestModel = MyRequestModel.fromJson(
  ...
  GetMyGroupApi() {
    checkInternet().then((internet) async {
      if (internet) {
        MyRequestProvider()
            .GetMyGroupApi(loginModel?.data?.user?.id.toString() ?? "")
            .then((response) async {
              myGroupRequestModel = MyGroupRequestModel.fromJson(
                jsonDecode(response.body),
              );
              if (response.statusCode == 200) {
  ...
  GetMyFriendRequest() {
    checkInternet().then((internet) async {
      if (internet) {
        MyRequestProvider()
            .GetFriendRequest(loginModel?.data?.user?.id.toString() ?? "")
            .then((response) async {
