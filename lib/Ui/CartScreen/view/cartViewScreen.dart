...
//   final List<String> orderFilters = ['All', 'Pending', 'Confirmed'];
//
//   // API data models
...
//                 backgroundColor: isDark ? Color(0xffbdab82) : AppColors.maincolor,
...
//       return allOrders;
//     } else if (selectedOrderFilter == 'Pending') {
//       return allOrders.where((order) =>
//       order.status?.toLowerCase() == 'pending').toList();
//     } else if (selectedOrderFilter == 'Confirmed') {
//       return allOrders.where((order) =>
//       order.status?.toLowerCase() == 'confirmed').toList();
//     }
//     return allOrders;
//   }
//
//   GetMyOrderApi(String status) {
//     setState(() {
//       isLoading = true;
//     });
//
...
//     String apiStatus = '';
//     if (status == 'Pending') apiStatus = 'Pending Approval';
//     if (status == 'Confirmed') apiStatus = 'Collected';
//
...
//               isLoading = false;
//             });
//             buildErrorDialog(context, 'Error', "Failed to load order2s");
//           }
//         }).catchError((error) {
//           setState(() {
//             isLoading = false;
//           });
//           log("werwerrewrwr$error");
...
//                 color: isDark ? Color(0xf0CBB88C) : AppColors.lightText,
//                 height: 10.w, // Tamari jaruriyat mujab size set karo
//                 width: 10.w,
//                 fit:
//                 BoxFit
//                     .scaleDown, // Aa property icon ne center ma nanu rakhse
//               ),
//             ),
//             SizedBox(height: 3.h),
//             Text(
