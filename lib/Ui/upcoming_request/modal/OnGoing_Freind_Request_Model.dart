// class OnGoingFreindRequestModel {
//   int? status;
//   String? message;
//   Data? data;
//
//   OnGoingFreindRequestModel({this.status, this.message, this.data});
//
//   OnGoingFreindRequestModel.fromJson(Map<String, dynamic> json) {
//     status = json['status'];
...
//             ? RequestedUserName.fromJson(json['requested_user_name'])
//             : null;
//   }
//
//   Map<String, dynamic> toJson() {
...
//       data['requested_user_name'] = this.requestedUserName!.toJson();
//     }
//     return data;
//   }
// }
//
// class RequestedUserName {
//   int? id;
//   int? role;
//   String? email;
//   var emailVerifiedAt;
