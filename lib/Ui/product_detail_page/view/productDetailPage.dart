            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: isDark ? const Color(0xff272727) : AppColors.bgcolor,
                  border: Border(
                    top: BorderSide(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: isDark ? const Color(0xffbdab82) : AppColors.white,
          width: 0.2.w,
        ),
        borderRadius: BorderRadius.circular(12),
      ),
      child: Row(
        children: [
          Icon(
            icon,
            size: icnSize ?? 24.sp,
            color: isDark ? const Color(0xffbdab82) : AppColors.maincolor,
          ),
          SizedBox(width: 4.w),
          Expanded(
            child: Column(
