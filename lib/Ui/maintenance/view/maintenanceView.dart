...
class _MaintenanceScreenState extends State<MaintenanceScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: theme.isDark ? const Color(0xff1A1A1A) : AppColors.white,
          ...
          SingleChildScrollView(
            child: Column(
              children: [
                ...
                SizedBox(height: 2.h),
                isLoading
                    ? const Loader().paddingOnly(top: 20.h)
              ...
              : Row(
                children: [
                  ...
                  FloatingActionButton.extended(
                    ...
                    backgroundColor:
                        theme.isDark ? const Color(0xffCBB88C) : Colors.white,
                    onPressed: () {
